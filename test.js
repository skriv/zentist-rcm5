...
function initSplit() {
  ...
  gsap.set(".modal-wrap", { display: "block", autoAlpha: 0 }),
    new SplitText(e, {
      ...
      t.classList.add("single-line-wrap"),
    ...
    Array.from(t)
      ...
      .forEach((e) => {
        e &&
          (e.elements[0].setAttribute("split-ran", "true"),
          e.elements[0].hasAttribute("data-letters-delay") &&
            e.chars.forEach((e, t) => {
              let a = t / 150 + "s";
              e.style.setProperty("transition-delay", a);
            }));
      }),
    gsap.set(".modal-wrap", { display: "none", autoAlpha: 1, clearProps: !0 });
}
function initLoad(e) {
  let t,
    a,
    r = document.querySelector(".nav-row"),
  ...
  let c = gsap.timeline({
    defaults: { ease: "osmo-ease", duration: 1.2 },
    onStart: () => {
  ...
  c
    .set(o, { autoAlpha: 1 }, 0.5)
    .to(i, { y: 0, stagger: staggerDefault })
    .to(r, { y: 0 }, "<"),
    s.length > 1 &&
      c.from(s, { yPercent: 20, autoAlpha: 0, stagger: staggerDefault }, 0.3),
    n && c.to(t, { y: 0, stagger: staggerDefault }, 0.3),
    l &&
      c.from(a, { autoAlpha: 0, duration: 0.6, stagger: staggerDefault }, 0.8);
}
function initTextScroll(e) {
  e.querySelectorAll('[data-reveal="scroll"]').forEach((e) => {
    (lines = e.querySelectorAll(".single-line")),
      gsap.to(lines, {
        y: 0,
...
function initRevealScroll(e) {
  e.querySelectorAll('[data-reveal="fade"]').forEach((e) => {
    gsap.from(e, {
      ...
      autoAlpha: 0,
      duration: durationDefault + 0.2,
      scrollTrigger: { trigger: e, start: "top bottom", once: !0 },
    });
  });
}
function initModal() {
  ...
  let t = document.querySelectorAll("[data-modal-cta]"),
    ...
    d = gsap
      ...
      .set(a, { display: "block" })
      .set(o, { display: "flex" })
      .fromTo(r, { opacity: 0 }, { opacity: 0.5 })
      .fromTo(
        o,
        {
      ...
      .fromTo(n, { y: "120%" }, { y: "0%", stagger: 0.02 }, ">-=0.8")
      .fromTo(
        [s, c],
    ...
    p = gsap
      ...
      .to(
        n,
        { y: "120%", stagger: { each: 0.03, from: "end" }, duration: 0.65 },
        "<"
      )
      .to(
        [s, c],
  ...
  t.forEach((e) => {
    e.addEventListener("click", () => {
      ...
      i.forEach((e) => {
        ...
        (o.querySelector(`[data-modal="${t}"]`).style.display = "flex"),
        (infoModalOpen = !0),
        d.play(0),
        "founders" === t && awardStackEffect.play(0);
    });
  }),
    l.forEach((t) => {
...
function initFaq(e) {
  function t(e) {
    n.forEach((t, a) => {
      ...
      if (a === e) {
        ...
        r.appendChild(l), Flip.from(e, { duration: 0.4 });
  ...
  o.classList.add("tab-button__bg"),
    o.setAttribute("data-flip-button", "bg"),
    r[0].appendChild(o),
    a.forEach((e) => {
      ...
      t.addEventListener("click", () => {
        a.forEach((t) => {
          t !== e &&
            "open" === t.getAttribute("data-state") &&
            t.querySelector(".faq-link").click();
        }),
          "closed" === e.getAttribute("data-state")
...
function initVideoModal() {
  function e() {
    ...
    d.appendChild(n),
      ...
      gsap.delayedCall(0.001, () => {
        Flip.from(t, { duration: 0.9 }), Flip.from(a, { duration: 0.9 });
      }),
      (videoModalOpen = !1);
  }
  ...
  let y = gsap
      ...
      .to(p, { autoAlpha: 0 })
      .to(m, { height: 0 }, "<")
      .fromTo(i, { opacity: 0 }, { opacity: 0.75 }, "<")
      .to(l, { autoAlpha: 0, duration: 0.5 })
      .set(u, { opacity: 1 }, "<"),
    f = gsap
      .timeline({ paused: !0 })
      .to(i, { opacity: 0 })
      .to(u, { opacity: 0, duration: 0.25 }, "<")
      .to(l, { autoAlpha: 1 }, "<")
      .set(r, { display: "none" })
      .to(p, { autoAlpha: 1, duration: 0.5 })
      .to(m, { height: "100%" }, "<+=0.25")
      .to(l, {
        autoAlpha: 1,
        duration: 0.001,
        overwrite: "auto",
  ...
  t.addEventListener("click", () => {
    ...
    y.play(0),
      ...
      c.appendChild(l),
      gsap.delayedCall(0.001, () => {
        Flip.from(e, { duration: 1.2 }),
          Flip.from(t, {
            duration: 1.2,
            onComplete: () => {
              isTouchScreendevice() ||
                vimeoPlayerPlay(o, Object.values(vimeoPlayers)[0]);
            },
          });
      });
  }),
    ...
    d.addEventListener("mouseenter", () => {
      gsap.to(g, {
        scrambleText: { text: "play reel", chars: "lowercase", speed: 0.8 },
      });
    }),
    d.addEventListener("mouseleave", () => {
      gsap.to(g, { scrambleText: { text: originalText, chars: "lowercase" } });
    });
}
function initVideos() {
  document.querySelectorAll("[data-vimeo-player-target]").forEach((e, t) => {
    ...
    (vimeoPlayers[a] = r),
      ...
      "false" === e.getAttribute("data-vimeo-player-autoplay")
        ? (r.setVolume(1), r.pause())
        : (r.setVolume(0),
          e.setAttribute("data-vimeo-status-muted", "true"),
          "false" === e.getAttribute("data-vimeo-status-paused-by-user") &&
            gsap.timeline({
              scrollTrigger: {
                trigger: e,
                start: "0% 100%",
      ...
      e.querySelectorAll('[data-vimeo-control="play"]').forEach((t) => {
        t.addEventListener("click", () => {
          "true" === e.getAttribute("data-vimeo-status-muted")
            ? r.setVolume(0)
            : r.setVolume(1),
            vimeoPlayerPlay(e, r);
        });
      ...
      e.querySelectorAll('[data-vimeo-control="pause"]').forEach((t) => {
        t.addEventListener("click", () => {
          vimeoPlayerPause(e, r),
            "true" === e.getAttribute("data-vimeo-player-autoplay") &&
              (e.setAttribute("data-vimeo-status-paused-by-user", "true"),
              tl && tl.kill());
        });
      }),
      ...
      document.addEventListener("mousemove", function () {
        clearTimeout(o),
          e.setAttribute("data-vimeo-status-hover", "true"),
          (o = setTimeout(() => {
      ...
      r.on("ended", () => {
        ...
        e.setAttribute("data-vimeo-status-activated", "false"),
          e.setAttribute("data-vimeo-status-play", "false"),
          r.unload(),
          t.click();
      });
  });
...
function vimeoPlayerPlay(e, t) {
  e.setAttribute("data-vimeo-status-activated", "true"),
    e.setAttribute("data-vimeo-status-play", "true"),
    t.play();
}
...
function initOsmoBasicFormValidation() {
  ...
  function a(e) {
    ...
    return (
      "email" === t.type
        ? (a = /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i))
        : (t.hasAttribute("min") && n < r && (a = !1),
          t.hasAttribute("max") && n > o && (a = !1)),
      a
    );
  }
  function r(e) {
    ...
    t &&
      ...
      a(e)
        ...
        : (e.classList.remove("is--success"), e.classList.add("is--error")));
  }
        ...
        t.addEventListener("input", function () {
          ...
          t.__validationStarted ||
            ("email" === t.type
              ...
              : ((t.hasAttribute("min") && o >= i) ||
                  (t.hasAttribute("max") && o <= n)) &&
                (t.__validationStarted = !0)),
            t.__validationStarted && r(e);
        }),
  ...
  e.querySelectorAll('[data-parallax="trigger"]').forEach((e) => {
    ...
    gsap.fromTo(
      ...
      { [s]: r },
      {
        [s]: o,
        ease: "none",
        scrollTrigger: { trigger: e, start: i, end: n, scrub: a },
      }
    );
  });
}
function initPricingCards(e) {
    ...
    e.addEventListener("click", () => {
      ...
      "annual" === g && g != l
        ? (() => {
            ...
            n.setAttribute("href", `${s}?type=annual`),
              p
                .fromTo(o, { yPercent: 0 }, { yPercent: -100 })
                .to(
                  a,
                  { scrambleText: { text: u, speed: 0.75 }, duration: 1 },
                  "<"
                )
                .to(
                  r,
                  { scrambleText: { text: d, speed: 0.75 }, duration: 1 },
                  "<"
                );
          })()
        : (() => {
            ...
            n.setAttribute("href", u),
              p
                ...
                .to(
                  a,
                  { scrambleText: { text: s, speed: 0.75 }, duration: 1 },
                  "<"
                )
                .to(
                  r,
                  { scrambleText: { text: c, speed: 0.75 }, duration: 1 },
                  "<"
                );
          })();
    });
  ...
  m.forEach((e) => {
    e.addEventListener("click", () => {
      b
        ? ((b = !1),
          g.setAttribute("data-card-state", "default"),
          h.clear(),
          h
            .to(v, {
              y: "120%",
            ...
            .to(y, { autoAlpha: 1, duration: 0.5 }, "<+=0.5")
            .set(f, { autoAlpha: 0 }))
        : ((b = !0),
          g.setAttribute("data-card-state", "overlay"),
          h.clear(),
          h
            .to(y, { autoAlpha: 0, duration: 0.5 })
            .set(f, { autoAlpha: 1 }, 0.1)
            .fromTo(
              v,
              { y: "120%" },
              { y: "0%", stagger: 0.03, overwrite: "auto" },
              "<+=0.1"
            ));
    });
  });
...
function initFooterLogo(e) {
  ...
  gsap.set([r, a], { transformOrigin: "center center" }),
    gsap
      .timeline({
        defaults: { duration: 1 },
        scrollTrigger: { trigger: t, start: "40% bottom", once: !0 },
      })
      .from(r, { autoAlpha: 0, rotate: -90, duration: 1.3 })
      .from(a, { x: "5em", autoAlpha: 0, stagger: 0.1 }, "<");
}
  ...
  menuButton.addEventListener("click", () => {
    menuOpen
      ...
      : ((menuOpen = !0),
        ...
        o
          .clear()
          .set([e, r], { display: "block" })
          .fromTo(r, { autoAlpha: 0 }, { autoAlpha: 1 })
          .fromTo(
            t,
            { autoAlpha: 1, y: "0em" },
          ...
          .fromTo(e, { yPercent: -120 }, { yPercent: 0 }, "<+=0.2")
          .fromTo(
            a,
    ...
    const t = e.querySelectorAll(
      ...
      i = (e) => {
        ...
        return (
          ...
          a && e.value.length < a && (i = !1),
          r && e.value.length > r && (i = !1),
          "email" !== o || /\S+@\S+\.\S+/.test(e.value) || (i = !1),
          i
            ? (t.classList.remove("is--error"), t.classList.add("is--success"))
            : (t.classList.remove("is--success"), t.classList.add("is--error")),
          i
        );
      },
      n = () => {
...
function initHomeDashboard(e) {
  function t() {
    c.setAttribute("data-notification-status", "active"),
      u && clearTimeout(u),
      (u = setTimeout(() => {
  ...
  gsap.set(l, { autoAlpha: 0 }),
    ...
    gsap
      ...
      .from(r, { rotateX: "20deg", z: "-20em" })
      .from(o, { z: "40em", autoAlpha: 0 }, "<")
      .from(i, { z: "35em", autoAlpha: 0 }, "<")
      .from(n, { z: (e) => 35 - 5 * e + "em", stagger: 0.01 }, "<")
      .to(l, { autoAlpha: 0, duration: 0.01 }, 0)
      .set(a, { pointerEvents: "none" });
  let d = gsap.timeline({
    paused: !0,
    defaults: { duration: 0.8 },
    onComplete: () => {
      gsap.set(a, { pointerEvents: "auto" });
    },
  });
  d
    .to([i, o, n], {
    ...
    .to(l, { autoAlpha: 1, stagger: 0.03, duration: 0.5 }, "<"),
    s.forEach((e) => {
  ...
  e.querySelectorAll("[data-video-on-hover]").forEach((e) => {
    ...
    "" !== t &&
      (e.addEventListener("mouseenter", () => {
        "" === a.getAttribute("src") && a.setAttribute("src", t),
          e.setAttribute("data-video-on-hover", "active"),
          a.play();
      }),
      e.addEventListener("mouseleave", () => {
        e.setAttribute("data-video-on-hover", "not-active"),
          setTimeout(() => {
...
function initSliders(e) {
  gsap.utils
    .toArray(e.querySelectorAll('[data-slider="list"]'))
    .forEach((e) => {
      function t() {
      ...
      function r() {
        u.next({ ease: "osmo-ease", duration: 0.725 }),
          (c = gsap.delayedCall(4, r));
      }
      const o = gsap.utils.toArray(e.querySelectorAll('[data-slider="slide"]')),
        i = e.closest(".section"),
        n = i
          ? gsap.utils.toArray(i.querySelectorAll('[data-slider="button"]'))
          : [];
      let l, s, c;
      ...
      u.toIndex(3, { ease: "linear", duration: 0.1 }),
        ScrollTrigger.create({
          trigger: e,
          start: "top 75%",
          once: !0,
          onEnter: () => {
            u.toIndex(4, { ease: "osmo-ease", duration: 0.725 });
          },
        }),
        ScrollTrigger.create({
          trigger: e,
        ...
        o.forEach((e, t) =>
          e.addEventListener("click", () =>
            u.toIndex(t, { ease: "osmo-ease", duration: 0.725 })
          )
        ),
        n.length > 0 &&
          n.forEach((e, t) => {
    ...
    gsap.context(() => {
      function r(e, t) {
        ...
        return (
          r > c.time() != e > f &&
            e !== f &&
            (r += c.duration() * (e > f ? 1 : -1)),
          (r < 0 || r > c.duration()) && (t.modifiers = { time: i }),
          (f = a),
          (t.overwrite = !0),
          gsap.killTweensOf(n),
          0 === t.duration ? c.time(i(r)) : c.tweenTo(r, t)
        );
      }
      let o,
        i,
        ...
        c = gsap.timeline({
          ...
          defaults: { ease: "none" },
          onReverseComplete: () =>
            c.totalTime(c.rawTime() + 100 * c.duration()),
        }),
        u = e.length,
        d = e[0].offsetLeft,
        p = [],
        ...
        q =
          !0 === b
            ? e[0].parentNode
            : gsap.utils.toArray(b)[0] || e[0].parentNode,
        E = () => {
          let a,
          ...
          e.forEach((e, t) => {
            ...
            gsap.set(e, { xPercent: (e) => y[e] }),
            (o =
              e[u - 1].offsetLeft +
              (y[u - 1] / 100) * g[u - 1] -
              d +
              m[0] +
              e[u - 1].offsetWidth * gsap.getProperty(e[u - 1], "scaleX") +
              (parseFloat(t.paddingRight) || 0));
        },
        x = () => {
          (A = b ? (c.duration() * (q.offsetWidth / 2)) / o : 0),
            b &&
              p.forEach((e, t) => {
                p[t] = i(
                  c.labels["label" + t] + (c.duration() * g[t]) / 2 / o - A
                );
              });
        },
        L = (e, t, a) => {
        ...
        T = () => {
          let t, a, r, n, l;
          for (c.clear(), t = 0; t < u; t++)
            (a = e[t]),
              (r = (y[t] / 100) * g[t]),
              (n = a.offsetLeft + r - d + m[0]),
              (l = n + g[t] * gsap.getProperty(a, "scaleX")),
              c
                .to(
                  a,
                  { xPercent: S(((r - l) / g[t]) * 100), duration: l / h },
                  0
                )
                .fromTo(
                  a,
        ...
        w = (e) => {
          ...
          c.progress(0, !0),
            ...
            e && T(),
            x(),
            e && c.draggable ? c.time(p[f], !0) : c.progress(t, !0);
        },
        k = () => w(!0);
      if (
        (gsap.set(e, { x: 0 }),
        ...
        (c.current = () => (v ? c.closestIndex(!0) : f)),
        (c.next = (e) => r(c.current() + 1, e)),
        (c.previous = (e) => r(c.current() - 1, e)),
        (c.times = p),
        c.progress(1, !0).progress(0, !0),
        t.reversed && (c.vars.onReverseComplete(), c.reverse()),
        ...
        (r = Draggable.create(n, {
          ...
          snap(e) {
            ...
            return (
              Math.abs(n) > c.duration() / 2 &&
                (n += n < 0 ? c.duration() : -c.duration()),
              (l = (r + n) / c.duration() / -t),
              l
            );
          },
  ...
  e.querySelectorAll('[data-flip-button="wrap"]').forEach((e) => {
    ...
    t.forEach(function (t) {
      t.addEventListener("mouseenter", function () {
        ...
        this.appendChild(a), Flip.from(e, { duration: 0.4 });
      }),
        ...
        t.addEventListener("mouseleave", function () {
          ...
          e.querySelector(".active").appendChild(a),
            Flip.from(t, { duration: 0.4 });
        }),
        t.addEventListener("blur", function () {
          const t = Flip.getState(a);
          e.querySelector(".active").appendChild(a),
...
function initTabSystem(e) {
  e.querySelectorAll('[data-tabs="wrapper"]').forEach((e) => {
    function t(e, t = !1) {
      ...
      u.classList.add("active"),
        ...
        y
          .to(g, { y: "-120%", stagger: 0.01 }, 0)
          .to(d, { autoAlpha: 0, xPercent: 3 }, 0)
          .fromTo(m, { y: "120%" }, { y: "0%", stagger: 0.075 }, 0.3)
          .fromTo(
            p,
    ...
    let a = e
        .querySelector('[data-tabs="nav"]')
        .querySelectorAll('[data-tabs="button"]'),
      r = e
        .querySelector('[data-tabs="content-wrap"]')
        .querySelectorAll('[data-tabs="content-item"]'),
      o = e
        .querySelector('[data-tabs="visual-wrap"]')
        .querySelectorAll('[data-tabs="visual-item"]'),
      i = a[0],
      n = r[0],
      l = o[0],
      s = !1;
  ...
  if (t) {
    ...
    t.addEventListener("click", () => {
      a.setAttribute("data-notification-status", "active"),
        gsap.fromTo(r, { opacity: 0 }, { opacity: 0.35, duration: 0.4 });
    });
    let o = t.querySelector("input");
    o &&
      o.addEventListener("blur", () => {
        a.setAttribute("data-notification-status", "inactive"),
          gsap.to(r, { opacity: 0, duration: 0.4 });
      });
  }
}
function initStartTextScroll(e) {
  ...
  gsap.set(o, { autoAlpha: 0 }),
    gsap
      ...
      .from(r, { autoAlpha: 0, stagger: 0.03, yoyo: !0, repeat: 1 })
      .fromTo(o, { autoAlpha: 0 }, { autoAlpha: 1, stagger: 0.03 }, ">-=0.1");
}
function createStackEffect(e) {
  ...
  gsap.set(a, {
    ...
    gsap.set(r, { z: (e) => -200 - 20 * e, rotationZ: -90 });
  const n = gsap.timeline({
    paused: !0,
    defaults: { duration: awardsStackDuration },
    onStart: () => {
  ...
  return (
    n
      ...
      .fromTo(
        r,
        { rotationZ: -150 },
        { rotationZ: (e) => 360 - 4 * e, stagger: 0.006 },
        0
      ),
    r.forEach((e) => {
      e.addEventListener("mouseenter", () => {
        gsap.to(e, { x: "-2em", duration: 0.4, ease: "power1" });
      }),
        e.addEventListener("mouseleave", () => {
          gsap.to(e, { x: "0em", duration: 0.4, ease: "power1" });
        });
    }),
    n
  );
  ...
  t.forEach((e) => {
    e.addEventListener("click", () => {
      ...
      if (a) {
        ...
        r && r.setAttribute("data-notification-status", "active"),
          setTimeout(() => {
            t && (t.textContent = "Copy"),
              r && r.setAttribute("data-notification-status", "not-active");
          }, 2e3);
      }
    });
  }),
    a.forEach((e) => {
      e.addEventListener("click", () => {
        ...
        a &&
          (function (e, t) {
            const a = new Blob([e], { type: "image/svg+xml" }),
    ...
    e.addEventListener("click", () => {
      ...
      if (a) {
        copyToClipboard(a.textContent),
          (e.querySelector("span").textContent = "Copied!");
        const t = document.querySelector('[data-notification="code-positive"]');
        t && t.setAttribute("data-notification-status", "active"),
          setTimeout(() => {
            (e.querySelector("span").textContent = "Copy"),
              t && t.setAttribute("data-notification-status", "not-active");
          }, 2e3);
      }
    });
  });
...
function initAboutScroll(e) {
  ...
  gsap
    .timeline({ scrollTrigger: { trigger: t, start: "top 60%", once: !0 } })
    .fromTo(r, { scaleX: 0.2 }, { scaleX: 1, duration: 1 })
    .fromTo(a[0], { x: "20em" }, { x: "0em", duration: 1.2 }, "<")
    .fromTo(a[1], { x: "-20em" }, { x: "0em", duration: 1.2 }, "<");
}
...
gsap.defaults({ ease: "osmo-ease", duration: durationDefault }),
...
initMobileMenu(),
  initUpdatesNumber(document),
  initPlausibleCustomEvents(document),
  barba.hooks.leave(() => {
    lenis.destroy();
  }),
  barba.hooks.enter((e) => {
  ...
  barba.hooks.afterEnter((e) => {
    ...
    e.next.namespace,
      ...
      void 0 === Webflow.env("editor") &&
        ...
        lenis.scrollTo(".page-w", { duration: 0.5, force: !0, lock: !0 }),
        lenis.on("scroll", ScrollTrigger.update),
        gsap.ticker.add((e) => {
          lenis.raf(1e3 * e);
        }),
    ...
    transitions: [
      {
        ...
        leave(e) {
          e.next.namespace,
            e.current.container.getAttribute("data-barba-namespace");
          ...
          return t.to(e.current.container, { autoAlpha: 0, duration: 0.5 }), t;
        },
        enter(e) {
          gsap
            .timeline({
            ...
            .from(e.next.container, { autoAlpha: 0, duration: 1 });
        },
      },
    ],
    views: [
      {
        ...
        afterEnter(e) {
          let t = e.next.container;
          initHomeDashboard(t),
            initPlayVideoHover(t),
            initFlipButtons(t),
            initSliders(t),
            initTabSystem(t),
            initPricingCards(t),
            initStartTextScroll(t),
            initModal(),
            initVideoModal(),
            initVideos(),
            initFeaturesIcons(t),
